...
const allNavItems: { tab: ActiveTab; label: string; icon: React.ReactNode; adminOnly?: boolean }[] = [
  ...
  { tab: 'borrowers', label: 'People', icon: <Users size={20} />, adminOnly: true },
  { tab: 'payments', label: 'Pay', icon: <Wallet size={20} />, adminOnly: true },
  { tab: 'installments', label: 'Schedule', icon: <Calendar size={20} />, adminOnly: true },
  { tab: 'analytics', label: 'Charts', icon: <BarChart3 size={20} /> },
  { tab: 'reports', label: 'Reports', icon: <FileText size={20} /> },
  { tab: 'settings', label: 'Settings', icon: <Settings size={20} />, adminOnly: true },
];
